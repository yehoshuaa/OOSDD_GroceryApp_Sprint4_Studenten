...
namespace TestCore
{
    public class TestHelpers
    {
        ...
        {
            string wrongPassword = "user1";
            //hash van "user3"
            string wrongHash = "sxnIcZdYt8wC8MYWcQVQjQ==.FKd5Z/jwxPv3a63lX+uvQ0+P7EuNYZybvkmdhbnkIHA=";

            Assert.IsFalse(PasswordHelper.VerifyPassword(wrongPassword, wrongHash));
        }
